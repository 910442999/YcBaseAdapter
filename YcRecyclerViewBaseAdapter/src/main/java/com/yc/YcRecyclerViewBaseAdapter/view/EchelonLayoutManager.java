package com.yc.YcRecyclerViewBaseAdapter.view;
...
import com.yc.YcRecyclerViewBaseAdapter.bean.ItemViewInfo;
...
public class EchelonLayoutManager extends RecyclerView.LayoutManager {
    ...
    public EchelonLayoutManager(Context context) {
        ...
        mItemViewWidth = (int) (getHorizontalSpace() * 0.95f);//item的宽
        //        mItemViewHeight = (int) (mItemViewWidth * 1.46f);//item的高
        mItemViewHeight = (int) (mItemViewWidth * 1.1f);//item的高
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        mItemViewWidth = (int) (getHorizontalSpace() * 0.95f);
        //        mItemViewHeight = (int) (mItemViewWidth * 1.46f);
        mItemViewHeight = (int) (mItemViewWidth * 1.1f);
