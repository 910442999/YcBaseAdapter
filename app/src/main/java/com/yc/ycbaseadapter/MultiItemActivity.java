...
import com.yc.ycbaseadapter.adapter.MultiItemAdapter;
...
public class MultiItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MultiItemAdapter(this);
        //设置 空布局
            ...
            public void onItemChildClick(YcBaseAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.item_btn:
                        ...
                        Toast.makeText(MultiItemActivity.this, "第一布局条目 :" + position + "----" + "条目数据 :" + o.toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case R.id.item_title:
                        Toast.makeText(MultiItemActivity.this, "第一布局条目 :" + position + "----" + "这是title", Toast.LENGTH_SHORT).show();
                        break;

                    case R.id.item_title1:
                        Toast.makeText(MultiItemActivity.this, "第二布局条目 :" + position + "----" + "这是title", Toast.LENGTH_SHORT).show();
                        break;
